...
```
docker run -v $WDIR:/home --name practical -p 14500:14500 -p 14501:14501 -p 14502:14502 -p 14503:14503 -p 6080:6080 -p 14600:14600 --rm teaching-phylo:xpra
```
To quit press `Ctrl C`.

Your local working directory will be mounted inside the container at /home/student/work. In your web browser, navigate to
```
